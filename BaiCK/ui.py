...
class ProductRecommendationUI:
    ...
    def show_product_rating_dialog(self, event):
        try:
            ...
            if not selected_items:
                messagebox.showwarning("Cảnh báo", "Vui lòng chọn một sản phẩm để đánh giá.")
                return
            ...
            def submit_rating():
                try:
                    ...
                    if self.user_id_entry.get() == user_id:
            ...
            print("Lỗi trong show_product_rating_dialog:", e)
            messagebox.showerror("Lỗi", str(e))
    ...
    def get_recommendations(self):
        try:
            ...
            print("Lỗi trong get_recommendations:", e)
            messagebox.showerror("Lỗi", str(e))
